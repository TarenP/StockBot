...
def run_replay(
    ...
    return _run_replay_v2(
        ...
        earnings_reaction_enabled=earnings_reaction_enabled,
        macro_regime_enabled=macro_regime_enabled,
        macro_regime_weight_strength=macro_regime_weight_strength,
        macro_regime_mode=macro_regime_mode,
        insider_adjustment_enabled=insider_adjustment_enabled,
        allow_unpromoted_feature_influence=allow_unpromoted_feature_influence,
...
def _replay_kwargs_from_live_config(live_config: dict | None = None) -> dict:
    ...
    return {
        ...
        "earnings_reaction_enabled": bool(live_config.get("earnings_reaction_enabled", False)),
        "macro_regime_enabled": bool(live_config.get("macro_regime_enabled", False)),
        "macro_regime_weight_strength": float(live_config.get("macro_regime_weight_strength", 0.08)),
        "macro_regime_mode": str(live_config.get("macro_regime_mode", "standard")),
        "insider_adjustment_enabled": bool(live_config.get("insider_adjustment_enabled", False)),
        "allow_unpromoted_feature_influence": bool(live_config.get("allow_unpromoted_feature_influence", False)),
