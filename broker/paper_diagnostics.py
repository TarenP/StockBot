...
def summarize_llm_sidecar_features(portfolio, cache_dir: str | Path = "broker/state/llm_cache") -> dict:
    ...
    return {
        ...
        "quality": {
            ...
            "cache_hit_rate": quality.get("cache_hit_rate"),
            "invalid_parse_rate": quality.get("invalid_parse_rate"),
            "by_event_type": quality.get("by_event_type"),
            "staleness": quality.get("staleness"),
            "trusted_parse_count_by_ticker": quality.get("trusted_parse_count_by_ticker"),
            "go_no_go": quality.get("go_no_go"),
