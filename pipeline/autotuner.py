...
def _base_replay_kwargs(cfg: dict, initial_cash: float) -> dict:
    return {
        ...
        "weak_theme_cooldown_cycles": _config_int(cfg, "weak_theme_cooldown_cycles", 0),
        "weak_theme_cooldown_min_hits": _config_int(cfg, "weak_theme_cooldown_min_hits", 2),
        "low_price_rank_policy": _config_str(cfg, "low_price_rank_policy", "late_cap"),
        "low_price_rank_penalty_mult": _config_float(cfg, "low_price_rank_penalty_mult", 0.70),
        "low_price_high_rank_floor": _config_float(cfg, "low_price_high_rank_floor", 0.80),
